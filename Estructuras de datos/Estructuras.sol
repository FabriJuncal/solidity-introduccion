...
/** 
    ...
    Las estructuras de datos en Solidity son tipos de datos personalizados que permiten a los programadores 
    definir objetos más complejos que combinan diferentes tipos de datos. Estas estructuras se pueden 
    utilizar para crear una sola variable que contenga varios campos de datos relacionados.
    Son parecidos a las Interfaces en TypeScript.
